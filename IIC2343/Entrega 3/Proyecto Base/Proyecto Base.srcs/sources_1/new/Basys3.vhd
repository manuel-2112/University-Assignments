...
signal muxin_out        : std_logic_vector(15 downto 0);
...
with ram_address select
    muxin_out <= sw                     when "0000000000000001",
...
with ram_address select
    load_dis <= write_ram when "0000000000000010",
                '0' when others;

with ram_address select
    load_led <= write_ram when "0000000000000000",
                '0' when others;
