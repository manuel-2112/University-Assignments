...
signal reg_input: std_logic_vector (11 downto 0) := "111111111111";
...
with flags select
    sum <= "000000000001" when "10",
           "111111111111" when "01",
           "000000000000" when others;

nst_Add : Adder12 port map(
    a => reg_output,
    b => sum,
    ci => '0',
    s => sum_result
